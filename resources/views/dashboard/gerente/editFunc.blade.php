...
.radio-inputs .radio input:checked + .name {
  ...
  font-weight: 600;
    ...
    <div data-aos="fade-left" class="card card-5">
        <div class="card-body">
            <form method="POST" action="{{ route('update.funcionario', ['id' => $funcionario->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text"
                                        value="{{ $funcionario->sobrenomeFuncionario }}"
                            ...
                            <div class="col-2" style="width: 200px;display: flex;">
                                <div class="input-group-desc">
                                    <input class="input--style-5" style="width:300px;" type="text"
                                        value="{{ $funcionario->especialidadeFuncionario }}"
                    ...
                    <div class="col-2" style="width: 250px;display: flex;">
                        <div class="input-group-desc">
                            <input class="input--style-5" style="width:640px;" type="text"
                                value="{{ $funcionario->emailFuncionario }}" @error('emailFuncionario') is-invalid @enderror
                ...
                <div class="form-row m-b-55">
                    ...
                    <div class="col-2" style="width: 100px;display: flex;">
                        <div class="input-group-desc">
                            ...
                            @php
                                $testeDD = '(' . substr($funcionario->numeroFuncionario, 0, 2) . ')'
                            @endphp
                                value="{{ $testeDD }}"
                        ...
                        <div class="input-group-desc" style="margin-left: 10%;">
                            <input class="input--style-5" style="width:300px;" type="text"
                                value="{{ substr($funcionario->numeroFuncionario, 2, 5) . '-' . substr($funcionario->numeroFuncionario, 7) }}"
                    ...
                    <div class="col-2" style="width: 300px;display: flex;">
                        <div class="input-group-desc" style="margin-left: 590px;">
                           <textarea style="width:500px;height:100px;border:0px;resize:none;" class="input--style-5" name="descricaoFuncionario" id="descricaoFuncionario" cols="30" rows="10">{{$funcionario->descricaoFuncionario}}</textarea>
                ...
                <div class="form-row m-b-55">
                    ...
                    <div class="col-2" style="width: 100px;display: flex;">
                        <div class="input-group-desc">
                            <input class="input--style-5" style="width:150px;" type="date" name="dataNascFuncionario" value='{{$funcionario->dataNascFuncionario}}'>
