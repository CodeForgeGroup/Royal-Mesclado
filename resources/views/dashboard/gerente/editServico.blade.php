  ...
  font-weight: 600;
    ...
    <div data-aos="fade-left" class="container" style="margin-top: 5%;">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s"
            ...
            <h6 class="section-title bg-white text-center text-primary px-3">Edite as informações do serviço no formulário a seguir</h6>
    ...
    <div data-aos="fade-left" class="card card-5">
        <div class="card-body">
            <form method="POST" action="{{ route('update.servico', ['id' => $servico->id]) }}" enctype="multipart/form-data">
                ...
                <div class="wrapper">
                    ...
                    <input type="file" name="fotoServico" id="image_file" style="display:none;" required>
                </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text" value="{{ $servico->nomeServico }}"
                                        required @error('nomeServico') is-invalid @enderror id="nomeServico"
                                        name="nomeServico" required maxlength="100">
                                    @error('nomeServico')
                            ...
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text"
                                        ...
                                        @error('descricaoServico') is-invalid @enderror id="descricaoServico"
                                        name="descricaoServico" required maxlength="100">
                            ...
                            <div class="col-2" style="width: 200px;display: flex;">
                                <div class="input-group-desc">
                                    <input class="input--style-5" style="width:300px;" type="text"
                                        ...
                                        @error('valorServico') is-invalid @enderror
                                        id="valorServico" name="valorServico" required
                                        maxlength="100">
                                    @error('valorServico')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="input-group-desc" style="margin-left: 20%;">
                                    <input class="input--style-5" style="width:300px;" type="text"
                                        value="{{ $servico->duracaoServico }}"
                                        @error('duracaoServico') is-invalid @enderror
                                        id="duracaoServico" name="duracaoServico" required
                                        maxlength="100">
