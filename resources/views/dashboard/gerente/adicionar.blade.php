        ...
        <form method="POST" action="{{ route('adc.func') }}"enctype="multipart/form-data">
                ...
                <div class="value">
                    <div class="row row-space">
                        <div class="col-2" style="width: 200px;display: flex;">
                            <div class="input-group-desc">
                                <input class="input--style-5" style="width:300px;" type="text" name="especialidadeFuncionario">
                                <label class="label--desc">Especialidade (Barbeiro)</label>
                            </div>
                            <div class="input-group-desc" style="margin-left: 20%;">
                                <input class="input--style-5" style="width:300px;" type="text" name="inicioExpedienteFuncionario">
                                <label class="label--desc">Inicio Expediente</label>
                            </div>
                        </div>
                        <div class="col-2" style="width: 670px;display: flex;">
                            <div class="input-group-desc">
                                <input class="input--style-5" style="width:300px;" type="text" name="fimExpedienteFuncionario">
                                <label class="label--desc">Fim Expediente</label>
                            </div>
                            <div class="input-group-desc" style="margin-left: 10%;">
                                <input class="input--style-5" style="width:300px;" type="text" name="salarioFuncionario">
            ...
            <div class="form-row m-b-55">
                ...
                <div class="col-2" style="width: 100px;display: flex;">
                    <div class="input-group-desc">
                        <input class="input--style-5" style="width:100px;" type="text" name="dddFuncionario" placeholder="(xx)">
                        <label class="label--desc">DDD</label>
                    </div>
                    <div class="input-group-desc" style="margin-left: 10%;">
                        <input class="input--style-5" style="width:300px;" type="text" name="telefoneFuncionario" placeholder="xxxxx-xxxx">
                ...
                <div class="col-2" style="width: 300px;display: flex;">
                    <div class="input-group-desc" style="margin-left: 590px;">
                       <textarea style="width:500px;height:100px;border:0px;resize:none;" class="input--style-5" name="descricaoFuncionario" id="descricaoFuncionario" cols="30" rows="10"></textarea>
            ...
            <div>
                <button style="background: #ff6d24 !important" class="btn btn--radius-2 btn--red" type="submit">Cadastro</button>
            </div>
        </form>
    </div>
</div>
